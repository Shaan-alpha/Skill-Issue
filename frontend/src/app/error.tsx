    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center px-4 py-8 text-center sm:px-6">
      ...
      <div className="glass w-full max-w-md space-y-6 rounded-3xl p-6 sm:p-10">
        ...
        <div className="space-y-2">
          <h1 className="text-2xl font-semibold">We hit something we didn&apos;t expect.</h1>
          <p className="text-sm text-muted-foreground leading-relaxed">
            The error has been reported. Try again — if it keeps happening, the GitHub API may be
            rate-limited or our backend is having a moment.
          </p>
          {error.digest ? (
