      ...
      <main className="relative z-10 flex w-full max-w-4xl flex-col items-center">
        ...
        >
          <motion.span
            ...
            className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] font-medium uppercase tracking-wider text-muted-foreground sm:text-xs"
          >
            Deterministic engineering reports · v0.2.0
          </motion.span>
