...
| **v0.1.0** | Backend MVP — GitHub ingestion + deterministic scoring | ⏳ in progress (Tasks 1–7 done on `feat/v0.1.0-backend-mvp`; next: Task 8 Engineering Maturity scorer) |
